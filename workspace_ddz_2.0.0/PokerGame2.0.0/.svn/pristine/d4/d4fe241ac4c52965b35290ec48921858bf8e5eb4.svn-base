...
//					//AnalyticsUtils.onClickEvent(mAct,  UC.EVENT_225);
//					HeadManager.getInstance().requestBuyHead(item);
//				}else{   //不是当前使用的，点击使用
//					//AnalyticsUtils.onClickEvent(mAct, UC.EVENT_226);
...
//		}
//		
//		if(goodItem.getId() == HallDataManager.getInstance().getUserMe().faceID){  //按钮状态
//			holder.ivGoodsBuy.setText("使用中");
//			holder.ivGoodsBuy.setEnabled(false);
//			holder.ivGoodsBuy.setBackgroundResource(R.drawable.btn_new_blue);
...
//			holder.ivGoodsBuy.setEnabled(true);
//			holder.ivGoodsBuy.setBackgroundResource(R.drawable.orange_big_selector);
//		}
