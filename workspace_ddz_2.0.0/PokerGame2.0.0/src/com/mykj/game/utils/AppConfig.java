...
public class AppConfig extends debug.IP_CONFIG_FILE {
	...
	public static String pay_version = "10.0"; // 支付组件版本号
	public static String PAY_WAY_VERSION = "1.3"; //支付列表下发版本号
	/**
	 * * @param platId
	 *            :平台ID 0：名游 2：百度 3：移动
	 */
	...
	/***************qpwap.cmgame.com*****************/
	public static final String	HOST	="http://qpwap3.139game.net";           //现网排行榜地址
	/** 短信购买后请求url*/
    ...
    /**消费排名地址*/
    public static final String RANK_PATH=API3+"/api.php";

    /**在线客服留言内容地址*/
    public static final String SERVER_ONLINE_PATH=API3+"/api.php";
    //public static final String SERVER_ONLINE_PATH="http://192.168.1.199:9001/api.php";
	...
	/**签到图片下载*/
//	public static final String SIGN_IMG_URL="http://image3.139game.com/signin/"+GAME_NAME+"/";
	public static final String SIGN_IMG_URL=imgUrl;
	
	
	/**游戏内音效下载*/
	public static final String GAME_MUSIC_URL="http://image3.139game.net/signin/"+GAME_NAME+"/music/";
...
//	public static String NEW_GETTICKET_URL="http://wap.139game.net/activity.php?ac=yuanbao";
	/**上传用户头像*/
	public static final String UPLOAD_HOST = HostAddressPool.API + "/index.php";/*"http://api.qwjj.cn/index.php"*/; //头像上传地址
	//public static final String UPLOAD_HOST = "http://192.168.6.128:8083/index.php";// 头像上传地址

	/**下载用户头像*/
	public static final String DOWNLOAD_HOST = HostAddressPool.imgUrl + "/avatar";/*"http://image.qwjj.cn/avatar"*/; //头像下载地址
	//public static final String DOWNLOAD_HOST = "http://avatar.qwjj.cn/avatar"; //头像下载地址
...
//	public static String BIND_URL = "http://192.168.1.186:18765/user.login";
	...
	public static int roomTimeOut = Short.MAX_VALUE;	
	
	public static boolean raffleSwitch; //乐透开关
    
	public static String fundataSuccess;
	public static String fundataFail;
	
	public static String buyGoodsTips;  //购买提示
	public static boolean buyButtonSwitch; //购买取消开关

	
	public static int firstGiftId = -1;  //首充道具id
	public static String firstGiftDesc = "testtest";  //首充描述
	public static int promotionShowType = 0;  //促销需要显示的类型，第一位登录送后，第二位退出，第三位取消首充
	public static int promotionId = -1;   //促销道具id
	public static String promotionDesc = "";  //促销描述
...
//		isCmccOpen = true;
	...
	public static void loadVersion(Context context){
		...
		try {
			...
			AppConfig.versionName = new String(
					tmpVersionName.getBytes("ISO-8859-1"), "UTF-8");
...
//				AppConfig.BIND_URL=pro.getProperty("bindUrl");
	...
	public static String getVersionName(Context context) {
		if (Util.isEmptyStr(AppConfig.versionName)) {
			// 如果没有读取则先读取
			loadVersion(context);
		}
