...
import com.mykj.andr.ui.tabactivity.TuHaoFragment.TuHaoItem;
...
public class TuHaoAdapter extends BaseAdapter {

	private Activity mAct;
	private List<ItemInfo> mList;
    private OnArticleTabSelectedListener mListener;
	public TuHaoAdapter(Activity act,List<ItemInfo> list,OnArticleTabSelectedListener listener) {
		mAct = act;
		mList = list;
        mListener=listener;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			item = new TuHaoItem();
			item.rankId_1 = (ImageView) convertView
					.findViewById(R.id.player_rank_1);
			item.rankId_2 = (ImageView) convertView
					.findViewById(R.id.player_rank_2);
			item.gender = (ImageView) convertView
					.findViewById(R.id.player_gender);
			...
			item = (TuHaoItem) convertView.getTag();
		}
