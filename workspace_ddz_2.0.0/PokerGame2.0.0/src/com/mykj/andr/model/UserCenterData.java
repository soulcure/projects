...
public class UserCenterData {
    ...
    public int winBout;//玩家赢的局数
    public int loseBout;//玩家输的局数
    public int winRatio;//玩家的胜率
    ...
    public UserCenterData(TDataInputStream tdis) {
        ...
        if (extendDataLen > 0) {
            ...
            scoreName = tdis.readUTF(len);
            winBout = tdis.readShort();
            loseBout = tdis.readShort();
            winRatio = tdis.readByteUnsigned();
        }
    }
