...
public class RoomConfigData implements Serializable {
	...
	public byte voiceTime = 0; //语音最大时间长度，单位s
	public int voiceDownTotal = 0; //语音最大总长度
	public int voiceDownMax = 0; //语音每次上传最大长度
	public short recordTime = 0; // 语音间隔时间限制
	
	public short wLimitLife;  //血条上限
	public byte calcshowTime; //结算时间
	...
	public RoomConfigData(TDataInputStream dis){
		...
		voiceTime = dis.readByte();
		voiceDownTotal = dis.readInt();
		voiceDownMax = dis.readInt();
		recordTime = dis.readShort();
		wLimitLife = dis.readShort();
		calcshowTime = dis.readByte();
	}
