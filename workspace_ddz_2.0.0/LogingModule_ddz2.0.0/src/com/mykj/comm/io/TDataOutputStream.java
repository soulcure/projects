...
public class TDataOutputStream extends ByteArrayOutputStream {
	...
	private boolean isFront = true; // 是否高位在前,默认为true：高位在前
	 ...
	 */
	public final static byte[] utf8toBytes(String _text) {
		if (_text == null) {
			return null;
		}
		try {
			return _text.getBytes("UTF-8");
