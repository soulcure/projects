...
public class FragmentEnd extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        SurveyPojo.SurveyPropertiesBean survery_properties = getArguments().getParcelable("survery_properties");

        assert survery_properties != null;
        textView_end.setText(Html.fromHtml(survery_properties.getEnd_message()));
