...
import com.taku.safe.adapter.CampusAdapter;
...
public class CampusFragment extends BasePermissionFragment implements View.OnClickListener {

    public final static String TAG = CampusFragment.class.getSimpleName();
    ...
    private void initView(View view) {
        ...
        mAdapter = new CampusAdapter(getContext());
