...
public class IndoorAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private List<RespIndoorList.PageInfoBean.StudentlistBean> mList;
    ...
    public void setList(List<RespIndoorList.PageInfoBean.StudentlistBean> list) {
        if (list != null)
            mList.addAll(list);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        final RespIndoorList.PageInfoBean.StudentlistBean item = mList.get(position);
        ...
        tv_info.setText(R.string.not_out);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(HardwareAnalysisDetailActivity.DETAIL_TYPE, HardwareAnalysisDetailActivity.INDOOR_DETAIL);
