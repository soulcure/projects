...
public class NotClassDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<RespNoClassDetail.EventListBean> mList;


    public NotClassDetailAdapter(Context context, List<RespNoClassDetail.EventListBean> list) {
        mContext = context;
        mList = list;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        final RespNoClassDetail.EventListBean item = mList.get(position);
