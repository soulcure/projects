...
public class SignTrackAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private List<RespSignList.SignlistBean> mList;

    public SignTrackAdapter(Context context) {
        mContext = context;
        mList = new ArrayList<>();
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_track_sign, parent, false);
