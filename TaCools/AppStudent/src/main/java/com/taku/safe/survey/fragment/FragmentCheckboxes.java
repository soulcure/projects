package com.taku.safe.survey.fragment;
...
import com.taku.safe.survey.Answers;
import com.taku.safe.survey.SurveyActivity;
...
public class FragmentCheckboxes extends Fragment {
    ...
    private SurveyPojo.QuestionsBean q_data;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        q_data = getArguments().getParcelable("data");

        textview_q_title.setText(q_data != null ? q_data.getQuestion_title() : "");
