...
import com.taku.safe.TaKuTeacherActivity;
...
public class MineTeacherFragment extends BasePermissionFragment implements View.OnClickListener {

    private static final String TAG = MineTeacherFragment.class.getSimpleName();
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.tv_school:
                ...
                intent.putExtra(MapActivity.SIGN_INFO, mTakuApp.getTeacherInfo());
                ...
                .setPositiveButton(R.string.btn_confirm,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                getActivity().startActivityForResult(intent, TaKuTeacherActivity.LOGIN_OUT);
                                //getActivity().finish();
                            }
                        })
