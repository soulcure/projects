...
public class MusicPlayAdapter extends RecyclerView.Adapter<MusicPlayAdapter.ViewHolder> {
    ...
    //true  FreePlayingActivity
    //false Mp3PlayingActivity
    private boolean witchActivity=true;
    ...
    public void setWitchAt(boolean witchActivity){
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }else if(mContext instanceof Mp3PlayingActivity){
                    ((Mp3PlayingActivity) mContext).readlyPlay(position);
        ...
        if (item.isTrial() && !isVip) {
            ...
            viewHolder.tvTag.setBackgroundDrawable(null);
        }
