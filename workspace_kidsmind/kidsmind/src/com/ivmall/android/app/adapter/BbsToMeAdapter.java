...
public class BbsToMeAdapter extends RecyclerView.Adapter<BbsToMeAdapter.ViewHolder> {

    private Context mContext;
    private List<BBSItem> mList;

    public BbsToMeAdapter(Context context) {
        this.mContext = context;
        mList = new ArrayList<BBSItem>();
    }


    public BbsToMeAdapter(Context context, List<BBSItem> list) {
        this.mContext = context;
        this.mList = list;
    }
    ...
    @Override
    public BbsToMeAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        String count = String.valueOf(item.getCommentCount());
