...
public class RecordPlayFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        int spacingInPixels = getResources().getDimensionPixelOffset(R.dimen.record_item_spacing);
        mListView.addItemDecoration(new RecordItemDecoration(spacingInPixels));
