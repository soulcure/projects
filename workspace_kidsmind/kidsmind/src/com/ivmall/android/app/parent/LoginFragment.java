...
*/
    ...
    private void mobileLogin(final String phoneNum, String smsCode) {
        ...
        loginUtils.setLoginInSuccess(new LoginUtils.LoginInListener() {
            ...
            public void onSuccess() {
                Toast.makeText(mAct, R.string.login_sucess, Toast.LENGTH_SHORT).show();
                etSmsCode.setText("");
        ...
        HttpConnector.httpPost(url, json, new IPostListener() {
            ...
            public void httpReqResult(String response) {
                ...
                if (resp.isSucess()) {
                    ...
                    int time;
                    try {
                        time = Integer.parseInt(smsCountdown);
                    } catch (NumberFormatException e) {
                        time = 60;
                    }
                    tvCountDown.setCountMillSecond(time * 1000);
                    tvCountDown.start();
    ...
    private class OnCreateProfileResult implements OnSucessListener {
        ...
        public void sucess() {
            ...
            //KidsMindApplication.insertProvider(mAct);  //for TCL big pad
            getActivity().finish();
        }
