...
import com.ivmall.android.app.adapter.BbsToMeAdapter;
...
public class AnswerToMeFragment extends Fragment {

    public static final String TAG = AnswerToMeFragment.class.getSimpleName();

    private Activity mAct;

    private RefreshRecyclerView mPullToRefreshView;
    private BbsToMeAdapter mAdapter;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mAdapter = new BbsToMeAdapter(getActivity());
        ...
        mPullToRefreshView.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                isPullRefresh = true;
                AnswerToMeFragment.this.onRefresh();
            }
        });
    ...
    private void onRefresh() {
        ...
        reqNoteComment(mainListIndex, offset);
    }
     ...
     * 2.0 我发布的帖子评论（社区）
     */
    private void reqNoteComment(final int start, final int offset) {
        String url = AppConfig.NOTE_COMMENT;
        ...
        HttpConnector.httpPost(url, json, new IPostListener() {
            ...
            public void httpReqResult(String response) {
                ...
                if (resp != null && resp.isSucess()) {
                    ...
                    if (count == 0 && isAdded()) {
                        ((BaseActivity) getActivity()).showTips(R.string.report_empty);
                    }
