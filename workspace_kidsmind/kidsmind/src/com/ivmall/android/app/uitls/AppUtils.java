...
import com.ivmall.android.app.dialog.ActionDialog;
...
//    }
    ...
    public void reqAction(final String location, final Activity activity) {
        ...
        String token = ((KidsMindApplication) (activity.getApplication())).getToken();
        ...
        HttpConnector.httpPost(url, json, new IPostListener() {
            ...
            public void httpReqResult(String response) {
                ...
                if (resp != null && resp.isSucess()) {
                    ...
                    /*if (AppUtils.isTopActiviy(activity, PlayListFragmentActivity.class.getName())
    ...
    public static void ADClick(Context context, int epId) {
        String url = AppConfig.REPORT_CLICK_AD;
        AdReportRequest request = new AdReportRequest();
