...
public class BuyVipDialog extends Dialog {
    ...
    private void setVipListInfo(List<VipListItem> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            View view = inflater.inflate(R.layout.goods_item_v, vipContainer, false);
            ...
            if (item.getPreferential() > 0) {
                String price = mContext.getResources().getString(R.string.money_ticket) + item.getPreferentialStr();
                tvCost.getPaint().setFlags(Paint.ANTI_ALIAS_FLAG);
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (price > 0) {
                        PaymentDialog dialog = new PaymentDialog(mContext, price, item.getVipGuid(), item.getVipDesc());
                        dialog.setPartnerProductId(item.getPartnerProductId());
                        dialog.show();
                    }
                }
            });
    ...
    private boolean judgeLogin() {
        boolean isLogin = ((KidsMindApplication) mContext.getApplicationContext()).isLogin();
        return isLogin;
    }
