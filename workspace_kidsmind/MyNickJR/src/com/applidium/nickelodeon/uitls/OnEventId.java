...
public class OnEventId {
    ...
    public static final String SMART_PLAY_SESSION = "smart_play_session";
    public static final String GOLBAL_KIDS = "golbal_kids";
    public static final String FAVORITE_CHANNEL = "favorite_channel";
    public static final String FREE_PLAY_ITEM = "free_play_item";
    ...
    public static final String SMART_PARENT = "smart_parent";
    ...
    public static final String GOTO_VIP = "goto_vip";
    public static final String BUY_VIP_GOODS = "buy_vip_goods";
    public static final String GOTO_BABYINFO = "goto_babyinfo";
    ...
    public static final String GOTO_PLAY_HISTORY = "goto_play_history";
    public static final String PLAY_HISTORY_ITEM = "play_history_item";
    public static final String GOTO_STUDY_REPORT = "goto_study_report";
    public static final String GOTO_USER_RESPONSE = "goto_user_response";
    public static final String USER_RESPONSE_CHIOCE = "user_response_chioce";
    public static final String USER_RESPONSE_INPUT = "user_response_input";
    public static final String USER_RESPONSE_COMMIT = "user_response_commit";
    public static final String GOTO_ABOUT_US = "goto_about_us";
