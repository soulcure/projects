...
import com.applidium.nickelodeon.entity.DomyInfo;
import com.applidium.nickelodeon.entity.DomyPayResult;
...
public class DomyPayActivity extends Activity {
    ...
    private String vipName; //购买的产品名称
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String token = ((MNJApplication) getApplicationContext()).getToken();
    ...
    private boolean callPaySDK(final PayResponse payResponse) {
        ...
        vipName = payResponse.getBody();  //购买的产品名称
        // 调用大麦支付apk
            ...
            public void httpReqResult(String response) {
                ...
                if (statusResponse.isSuccess()) {
                    if (statusResponse.isTradeResult()) {
                        ((MNJApplication) getApplication()).reqUserInfo(DomyPayActivity.this, vipName);
                    } else {
                        if (mQueryCount > 0) {
                            Message msg = mHandler.obtainMessage();
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case PAY_SDK_RESULT: {
                    ...
                    req.setToken(((MNJApplication) getApplication())
                            .getToken());
