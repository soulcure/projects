...
public class MyPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onNotificationClicked(Context context, String title, String description, String customContentString) {
        ...
        Toast.makeText(context, "推送：" + title + "自定义：" + customContentString, Toast.LENGTH_SHORT).show();
        Log.e("koen", "推送：" + title + "自定义：" + customContentString);
    }
    ...
    public static void setWatchdog(Context context, ControlResponse resp) {
        ...
        if (type == ControlResponse.ControlType.close) {
            intent.setAction("com.ivmall.android.app.action.CloseApp");
        } else if (type == ControlResponse.ControlType.remoteSend) {
            intent.setAction("com.ivmall.android.app.action.Play");
            intent.putExtra("token", token);
        } else if (type == ControlResponse.ControlType.confirm) {
     ...
     * 定时创建服务
     */
    public static void setWatchdog(Context context, ControlResponse.ControlType type) {
        Intent intent = new Intent();
        intent.setClass(context, ControlHandlerReceiver.class);
        if (type == ControlResponse.ControlType.close) {
            intent.setAction("com.ivmall.android.app.action.CloseApp");
