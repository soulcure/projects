...
public class CartoonFragment extends Fragment {
    ...
    private void reqMainList(final int start, final int offset) {
        ...
        request.setCategory(MainPlayListRequest.TAB_ENTERTAINMENT);   //英文动画
    ...
    private class CartoonRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
            ...
            if (!item.isEnd()) {
                ...
                tv_info.setText("");
                tv_info.setBackgroundColor(getResources().getColor(R.color.transparent));
            }
            ...
            ((ViewHolder) viewHolder).mirrorItemView.getContentView()
                    .setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            BaiduUtils.onEvent(mAct, OnEventId.FREE_PLAY_ITEM, getString(R.string.free_play_item) + item.getTitle());
                        }
                    });
    ...
    private class ViewHolder extends RecyclerView.ViewHolder implements View.OnFocusChangeListener {
        ...
        public ViewHolder(View itemView) {
            ...
            //img_lang = (ImageView) itemView.findViewById(R.id.img_lang);
