package com.ivmall.android.app.debug;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private void saveCrashInfoToFile(Throwable ex) {
        ...
        printWriter.close();
        try {
            int userId = ((KidsMindApplication) mContext.getApplicationContext()).getUserId();
            String fileName = "crash_" + userId + "_" + dateFormat.format(new Date(System.currentTimeMillis())) + CRASH_REPORTER_EXTENSION;
    ...
    public void getCrashDeviceInfo(Context context, Map<String, String> params) {
        ...
        String phoneNum = ((KidsMindApplication) context.getApplicationContext()).getMoblieNum();
